...
const en = {
  ...
  booth: {
    title1: "The ",
    titleHi: "Photobooth",
    step1: "1 · Pick your layout",
    layoutStrip4: "🎞️ Classic strip · 1×4",
    layoutGrid4: "🍱 Cute grid · 2×2",
    layoutGrid6: "✨ Full grid · 2×3",
    shotsInfo: "Mochi takes 8 shots — then you pick your favorites! 💖",
    stepFrame: "2 · Pick your frame",
    frameInfo: "Your frame is applied automatically after you shoot — just like a real booth! ✨",
    step2: "2 · What kind of moment?",
    step3: "3 · What kind of moment?",
    open: "Open the booth 💖",
    ...
    pickFavorites: "Pick favorites → 💖",
    selectMochi: "Which ones make your heart go doki-doki? 💓",
    selectTitle: (n: number) => `Pick your ${n} favorite shots!`,
    selectCount: (sel: number, total: number) => `${sel}/${total} picked`,
    selectBack: "← Shoot again",
    decorate: "Decorate → 🎀",
...
const th: Dict = {
  ...
  booth: {
    title1: "",
    titleHi: "โฟโต้บูธ",
    step1: "1 · เลือกเลย์เอาต์",
    layoutStrip4: "🎞️ สตริปคลาสสิก · 1×4",
    layoutGrid4: "🍱 ตารางน่ารัก · 2×2",
    layoutGrid6: "✨ ตารางจัดเต็ม · 2×3",
    shotsInfo: "โมจิจะถ่ายให้ 8 รูป แล้วค่อยเลือกรูปโปรดทีหลัง! 💖",
    stepFrame: "2 · เลือกกรอบ",
    frameInfo: "พอถ่ายเสร็จจะติดกรอบนี้ให้อัตโนมัติ — เหมือนตู้จริงเลย! ✨",
    step2: "2 · เป็นช่วงเวลาแบบไหน?",
    step3: "3 · เป็นช่วงเวลาแบบไหน?",
    open: "เปิดตู้ถ่ายรูป 💖",
    ...
    pickFavorites: "เลือกรูปโปรด → 💖",
    selectMochi: "รูปไหนทำใจเต้นแรงสุด เลือกเลย! 💓",
    selectTitle: (n: number) => `เลือกรูปโปรด ${n} รูปเลย!`,
    selectCount: (sel: number, total: number) => `เลือกแล้ว ${sel}/${total}`,
    selectBack: "← ถ่ายใหม่",
    decorate: "ไปตกแต่ง → 🎀",
